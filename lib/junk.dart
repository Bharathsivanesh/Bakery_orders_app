...
class junk extends StatefulWidget {
  ...
  @override
  State<junk> createState() => _chatState();
}

class _chatState extends State<junk> {
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            method("BURGER", "images/bur.jpg", 50),
                            method("FRENCH-FRIES", "images/french.jpg", 25),
                          ],
                        ),
                        SizedBox(
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: [
                            method("CHICKEN-ROLL", "images/roll.jpg", 30),
                            method("SAN-VEG", "images/san.jpg", 25),
                          ],
                        ),
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.02),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: [
                            method("BREAD-OMBLET", "images/omb.jpg", 50),
                            method("VEG-ROLL", "images/roll.jpg", 20),
                          ],
                        ),
                      ],
                    ),
