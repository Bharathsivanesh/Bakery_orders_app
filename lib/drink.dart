...
class drink extends StatefulWidget {
  ...
  @override
  State<drink> createState() => _chatState();
}

class _chatState extends State<drink> {
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            method(
                                "POMEGRANATE-JUICE", "images/pjuice.jpg", 50),
                            method("ORANGE-JUICE", "images/ojuice.jpg", 25),
                          ],
                        ),
                        SizedBox(
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: [
                            method("GRAPE-JUICE", "images/gjuice.jpg", 30),
                            method("APPLE-JUICE", "images/apjuice.jpg", 25),
                          ],
                        ),
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.02),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: [
                            method("7UP", "images/7up.jpg", 50),
                            method("COCACOLE", "images/cojuice.jpg", 20),
                          ],
                        ),
                      ],
                    ),
