...
class puff extends StatefulWidget {
  const puff({Key? key}) : super(key: key);

  @override
  State<puff> createState() => _chatState();
}

class _chatState extends State<puff> {
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            method("EGG-PUFF", "images/egg.jpg", 30),
                            method("VEG-PUFF", "images/veg.jpg", 25),
                          ],
                        ),
                        SizedBox(
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: [
                            method("MUSHROOM-PUFF", "images/mushroom.jpg", 30),
                            method("CHICKEN-PUFF ", "images/chi.jpg", 25),
                          ],
                        ),
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.02),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: [
                            method("PNEER-PUFFS", "images/panner.jpg", 50),
                            method("SAMOSA", "images/sam.jpg", 20),
                          ],
                        ),
                      ],
                    ),
