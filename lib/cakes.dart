...
class cake extends StatefulWidget {
  ...
  @override
  State<cake> createState() => _chatState();
}

class _chatState extends State<cake> {
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            method("LGBT", "images/lgbt.jpg", 30),
                            method("RED VELVET", "images/red.jpg", 25),
                          ],
                        ),
                        SizedBox(
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: [
                            method("BLACK FOREST", "images/black.jpg", 60),
                            method("CHOCALATE CAKE", "images/choco.jpg", 55),
                          ],
                        ),
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.02),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: [
                            method("SPONGE CAKE", "images/spon.jpg", 20),
                            method("NUTS CAKE", "images/nuts.jpg", 50),
                          ],
                        ),
                      ],
                    ),
